...
def custom_heuristic_4(game, player):
    if game.is_loser(player):
        return float("-inf")
    if game.is_winner(player):
        return float("inf")
...
class CustomPlayer:
    ...
    def get_move(self, game, legal_moves, time_left):
        ...
        **********************************************************************
        ...
        move = (-1,-1)
        # checking if there are any legal moves possible or not
        ...
        try:
            ...
            if self.iterative: # using iterative deepening 
                depth = 0
                while True:
                    depth += 1
    ...
    def minimax(self, game, depth, maximizing_player=True):
        ...
        moves = game.get_legal_moves() # a list of moves
		
        #initializing the bestScore
        ...
        for move in moves:
            ...
            if maximizing_player: #max level
                score,_ = self.minimax(forecast_game, depth-1, False)
                if score > bestScore:
                    bestScore = score
                    bestMove = move
                    
            else: #min level
                score,_ = self.minimax(forecast_game, depth-1, True) 
                if score < bestScore:
                    bestScore = score
                    bestMove = move
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf"), maximizing_player=True):
        ...
        for move in moves:
            forecast_game = game.forecast_move(move)
            if maximizing_player: #max level
                score,_ = self.alphabeta(forecast_game, depth-1, alpha, beta, False) #recursion
                if score > bestScore:
                    bestScore = score
                    bestMove = move
                ...
                score,_ = self.alphabeta(forecast_game, depth-1, alpha, beta, True) #recursion
                if score < bestScore:
                    bestScore = score
                    bestMove = move
